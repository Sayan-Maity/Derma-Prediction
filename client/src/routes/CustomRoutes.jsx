...
import DermaDetection from "../pages/dashboardPages/dermaDetection/DermaDetection";
...
import SearchDisease from "../pages/dashboardPages/searchDisease/SearchDisease";
import SkinCare from "../pages/dashboardPages/skinCare/SkinCare";
import HealthAnalytics from "../pages/dashboardPages/healthAnalytics/HealthAnalytics";
import CommunityForum from "../pages/dashboardPages/communityForum/CommunityForum";
import UpgradePlan from "../pages/dashboardPages/upgradePlan/UpgradePlan";
import PaymentSuccess from "../pages/dashboardPages/upgradePlan/paymentStatus/PaymentSuccess";
import DoctorConsultation from "../pages/dashboardPages/doctorConsultation/DoctorConsultation";
